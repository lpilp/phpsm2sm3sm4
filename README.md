# 写在最前面
* AI发展太快了，两年前刚开始使用AI　codeing时让它写个国密算法，那是根本没法用。现在用AI写的代码可完全可用。
* 国密只是一个算法，不是大工程，用AI写的都没有问题，如果有什么接入的问题，其他用codex或是CC让它们看一下就可以解决了。这个项目太臃肿了
* 大家要接入第三方的时候，直接让AI给写一个就行了，还可以定制化。
* 先让AI读对方提供的SDK，然后再提出你的需求，让AI完成，最后再换几个AI让他们完善下安全性问题或是可能存在的bug。基本就很完美了
...
* 用AI洗一下整个项目，去掉php-ecc ,弄了个新项目，目前没有全面测试，有兴趣的朋友可以试试   https://github.com/lpilp/aiphpsm 
## 安装
