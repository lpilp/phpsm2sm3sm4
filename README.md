...
=======
  1. 暂无使用外部密码明文生成公私钥的类构造函数，比较简单可自行添加
  2. sm2的加解密例子中只有EncryptAsn1，这种asn1过的编码的例子，其实在sm2中有直接Encrypt函数， sm2.Encrypt(pub, data, rand, C1C3C2)， 与其它语言生成的加密串在c1部分多加了一个\x04, 在与其它语言进行互通时，请自行处理
>>>>>>> 0047ceaa49e372b404eeb85314d77a61f403daf6
